...
PROMO_CODE = "yass69"
CHANNEL_ID = os.getenv("CHANNEL_ID", "")  # ex: @moncanal
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    await update.message.reply_text(
        "🤖 Bot Hacoo prêt.\n\n"
        "Envoie simplement un lien Hacoo/OnlyAff et je prépare la publication.\n\n"
...
def main():
    if not BOT_TOKEN or not CHANNEL_ID:
        raise SystemExit(
            "Configure BOT_TOKEN et CHANNEL_ID avant de lancer le bot."
        )
